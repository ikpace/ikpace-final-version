...
//         isMobile,
//         toggleSidebar: () => {
//           const newOpen = !(openProp ?? open)
//           onOpenChange?.(newOpen)
//           setOpen(newOpen)
//         },
//       }),
//       [open, openProp, onOpenChange, isMobile]
//     )
...
//     if (isMobile) {
//       return <SidebarSheet ref={ref} {...props} />
//     }
...
//       data-sidebar="rail"
//       className={cn(
//         "absolute inset-y-0 z-50 hidden w-4 -translate-x-full transition-all group-data-[side=left]:-left-4 group-data-[side=right]:left-full group-hover/sidebar:translate-x-0 group-data-[side=left]:lg:translate-x-0",
//         className
//       )}
//       {...props}
//     />
...
//         "peer-data-[state=collapsed]:lg:ml-[calc(var(--sidebar-width-icon))]",
//         "md:ml-[calc(var(--sidebar-width))]",
//         className
//       )}
//       {...props}
//     />
...
//       data-sidebar="input"
//       className={cn(
//         "flex h-8 w-full rounded-md border border-sidebar-border bg-sidebar-accent px-3 py-2 text-sm ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-sidebar-foreground/50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-sidebar-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50",
//         className
//       )}
//       {...props}
//     />
...
//         outline:
//           "bg-sidebar-background hover:bg-sidebar-accent hover:text-sidebar-accent-foreground border border-sidebar-border",
//       },
//       size: {
//         default: "h-8 text-sm",
//         sm: "h-7 text-xs",
...
//         "group-data-[collapsible=icon]:hidden",
//         "peer-data-[size=sm]/menu-button:right-0",
//         "peer-data-[size=default]/menu-button:right-1",
//         "peer-data-[size=lg]/menu-button:right-2",
//         className
//       )}
//       {...props}
//     />
...
// const SidebarSheet = React.forwardRef(({ className, children, ...props }, ref) => {
...
//         className={cn("w-[--sidebar-width-mobile] p-0 [&>button]:hidden", className)}
//         ref={ref}
//       >
//         {children}
//       </SheetContent>
