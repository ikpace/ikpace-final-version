...
export default function CourseDetails() {
  ...
  const courseData = {
    "virtual-assistant-pro": {
      ...
      description:
        "Become a certified Virtual Assistant in just 6 weeks. Learn email management, calendar scheduling, social media assistance, and client communication skills.",
      fullDescription:
      ...
      instructorBio:
        "Amara has trained over 2,000 virtual assistants and runs her own successful VA agency. She brings real-world experience and proven strategies to help you launch your VA career.",
      instructorImage:
    ...
    "social-media-marketing": {
      ...
      description:
        "Learn to create engaging content, run effective ad campaigns, and grow your social media presence.",
      fullDescription:
        "This 6-week social media marketing course takes you from understanding platforms to creating full campaign strategies. Learn content planning, branding, paid promotions, analytics tracking, and present your own marketing campaign as a final project.",
      price: 7,
      originalPrice: 49,
      duration: "6 Weeks",
      students: 2156,
      ...
      instructorBio:
        "Kofi has managed social media for major brands and has helped hundreds of students master digital marketing.",
      instructorImage:
    ...
    "canva-graphic-design": {
      ...
      description:
        "Learn to create professional designs using Canva. Master typography, color theory, and branding.",
      fullDescription:
        "This 4-week course teaches you everything from color theory and typography to creating logos, flyers, posters, and complete social media branding kits using Canva. Graduate with a professional portfolio showcasing your design skills.",
      price: 7,
      originalPrice: 39,
      duration: "4 Weeks",
      students: 2890,
      ...
      instructorBio:
        "Esi has been a professional graphic designer for 8 years and has helped thousands learn Canva.",
      instructorImage:
    ...
    "smart-kids-coding": {
      ...
      description:
        "Introduce kids to coding through fun projects and games using Scratch.",
      fullDescription:
        "This exciting 4-week coding program is designed for children ages 6-12. Using Scratch, kids learn coding fundamentals through fun projects — building animations, stories, and their very own games. The course culminates in a final game project with a presentation and certificate ceremony.",
      price: 7,
      originalPrice: 35,
      ...
      instructorBio:
        "Ms. Akosua has been teaching kids coding for 5 years and makes learning fun and engaging.",
      instructorImage:
        "https://images.pexels.com/photos/1239291/pexels-photo-1239291.jpeg",
      image:
    ...
    "freelancing-online-income": {
      ...
      description:
        "Learn how to start freelancing, find clients, and build sustainable online income.",
      fullDescription:
        "This practical 4-week course teaches you how to launch your freelancing career from scratch. Learn to create winning profiles, write compelling proposals, find and retain clients, set up payment methods, and build a long-term sustainable freelance business.",
      price: 7,
      originalPrice: 39,
      duration: "4 Weeks",
      students: 3210,
      ...
      instructorBio:
        "Samuel has been a successful freelancer for 10 years and has helped thousands start their freelance journey.",
      instructorImage:
    ...
    return (
      <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white py-16 px-4">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <h2 className="text-2xl font-bold text-[#1A3D7C] mb-4">
            Course Not Found
          </h2>
          ...
          <Link
            to="/courses"
            className="bg-[#1A3D7C] text-white px-6 py-3 rounded-lg inline-flex items-center gap-2"
          >
            <ArrowLeft size={18} />
            Back to Courses
          </Link>
          ...
          <div className="md:col-span-2 space-y-8">
            ...
            <div className="bg-white rounded-xl shadow-lg p-4">
              ...
              <div className="p-6">
                  ...
                  <div className="space-y-6">
                    ...
                    {course.toolsNeeded && (
                      <div>
                        ...
                        <ul className="space-y-2">
                          {course.toolsNeeded?.map((req, index) => (
                            <li key={index} className="flex items-start gap-2">
                              <CheckCircle
                                size={18}
                                className="text-green-500 flex-shrink-0 mt-1"
                ...
                {activeTab === "reviews" && course.testimonials && (
                  <div>
                    <h3 className="text-xl font-bold text-[#1A3D7C] mb-4">
                      Student Reviews
                    </h3>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-gradient-to-br from-[#1A3D7C] to-[#FF7A00] rounded-xl shadow-lg p-6 text-white">
              ...
              <p className="text-white/90 mb-4">
                Get unlimited access to this course and more
              </p>
